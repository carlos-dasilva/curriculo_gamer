              ...
              <li key={`${s.path}-${idx}`} className="group rounded-2xl border border-gray-200/80 bg-white/95 p-5 shadow-md ring-1 ring-gray-100/80 transition duration-200 hover:shadow-lg hover:-translate-y-0.5 supports-[backdrop-filter]:bg-white/80 focus-within:ring-2 focus-within:ring-sky-500">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  <a
                    ...
                    className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:rounded-sm"
                  >
                    {s.name}
                  </a>
                </h3>
                ...
                <div className="mt-4">
                  <a
                    ...
                    target={s.path.startsWith('http') ? '_blank' : undefined}
                    rel={s.path.startsWith('http') ? 'noopener noreferrer' : undefined}
                    className="inline-flex items-center rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                  >
