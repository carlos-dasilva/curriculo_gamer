      ...
      <AdminLayout title="Estúdios">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <div className="hidden">
            <Link href="/admin/estudios/novo" className="inline-flex items-center rounded-md bg-sky-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700">
              Novo estúdio
            </Link>
          </div>
        </div>
          ...
          <table className="min-w-[720px] w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Contato</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {studios.data.map((s) => (
                <tr key={s.id}>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-700">{s.email || s.phone || '-'}</td>
