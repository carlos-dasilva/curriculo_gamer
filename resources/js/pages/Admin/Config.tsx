        ...
        <form onSubmit={submit} className="space-y-8" aria-label="Formulário de configuração do site">
          <section>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Field label="E-mail" id="email" type="email" value={data.email} onChange={(v) => setData('email', v)} error={errors.email} placeholder="contato@exemplo.com" />
              <Field label="Telefone" id="telefone" value={data.telefone} onChange={(v) => setData('telefone', v)} error={errors.telefone} placeholder="(00) 0000-0000" />
            </div>
            <div className="mt-4">
              <Field label="Endereço" id="endereco" value={data.endereco} onChange={(v) => setData('endereco', v)} error={errors.endereco} placeholder="Rua Exemplo, 123 - Cidade/UF" />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Field label="GitHub" id="github" value={data.github} onChange={(v) => setData('github', v)} error={errors.github} placeholder="https://github.com/sua-org/seu-repo" />
              <Field label="LinkedIn" id="linkedin" value={data.linkedin} onChange={(v) => setData('linkedin', v)} error={errors.linkedin} placeholder="https://www.linkedin.com/in/seu-perfil/" />
              <Field label="Instagram" id="instagram" value={data.instagram} onChange={(v) => setData('instagram', v)} error={errors.instagram} placeholder="https://www.instagram.com/seu-perfil/" />
              <Field label="Facebook" id="facebook" value={data.facebook} onChange={(v) => setData('facebook', v)} error={errors.facebook} placeholder="https://www.facebook.com/seu-perfil/" />
              <Field label="X (Twitter)" id="x" value={data.x} onChange={(v) => setData('x', v)} error={errors.x} placeholder="https://x.com/seu-perfil" />
              <Field label="YouTube" id="youtube" value={data.youtube} onChange={(v) => setData('youtube', v)} error={errors.youtube} placeholder="https://www.youtube.com/@seu-canal" />
              <Field label="WhatsApp" id="whatsapp" value={data.whatsapp} onChange={(v) => setData('whatsapp', v)} error={errors.whatsapp} placeholder="https://wa.me/5599999999999 ou número" />
            </div>
          </section>
