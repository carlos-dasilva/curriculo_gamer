...
export default function SolicitationEdit({ game, studios, platforms, tags }: Props) {
  ...
  const triggerN8n = async () => {
    ...
    try {
      // @ts-ignore
      await window.axios.post(`/opcoes/solicitacoes/${game.id}/n8n`);
