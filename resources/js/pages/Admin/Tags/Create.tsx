          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <div className="flex items-end gap-2">
                ...
                <button type="button" onClick={generateSlug} className="inline-flex items-center rounded-md bg-gray-200 px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-300">Gerar</button>
              </div>
